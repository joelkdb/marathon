 ...
 * @author joelkdb
 */
@Named(value = "marathonBean")
@ViewScoped
@ManagedBean(name = "marathonBean")
public class MarathonBean extends GenericBean<Marathon, String> {
    ...
    public Boolean isMarathonAvailable() {
...
//        FacesContext context = FacesContext.getCurrentInstance();
    ...
    public Marathon getActual() {
        return actual;
    }

    public void setActual(Marathon actual) {
        this.actual = actual;
    }
